    ...
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-10">
        <div class="px-6 py-6 bg-white rounded-lg shadow-xl">
            ...
            <div class="flex items-center justify-between mt-6">
                <div>
                    <svg class="w-12 2xl:w-16 h-12 2xl:h-16 p-1 2xl:p-3 bg-indigo-400 bg-opacity-20 rounded-full text-indigo-600 border border-indigo-600"
        ...
        <div class="px-6 py-6 bg-white rounded-lg shadow-xl">
            ...
            <div class="flex items-center justify-between mt-6">
                <div>
                    <svg class="w-12 2xl:w-16 h-12 2xl:h-16 p-1 2xl:p-3 bg-blue-400 bg-opacity-20 rounded-full text-blue-600 border border-blue-600"
                        fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1"
    ...
    <div class="flex flex-col xl:flex-row space-y-4 xl:space-y-0 xl:space-x-4">
        ...
        <div class="w-full xl:w-1/3 p-6 space-y-6 bg-white rounded-lg shadow-xl capitalize">
            ...
            <section x-data="statsByCategory" class="space-y-6">
                ...
                <p class="text-center text-xl font-semibold text-gray-700" x-text="`${currentItem.name}`">
                </p>
        ...
        <div x-data="productOverviewStats" class="w-full xl:w-1/3 p-6 space-y-6 bg-white shadow-xl rounded-lg">
            ...
            <section class="space-y-6">
                <div class="flex items-center justify-center" x-data="{ circumference: 2 * 22 / 7 * 110 }">
                    ...
                    <span class="absolute text-5xl font-bold text-green-500"
                        x-text="`${Math.round((project.completed / (project.completed + project.in_progress)) * 100)}%`"></span>
                </div>
            </section>
        ...
        <div class="w-full xl:w-2/3 bg-white shadow-xl rounded-lg space-y-1">
            ...
            <div class="flex">
                ...
                <div class="w-full flex justify-between p-4 bg-gray-100 hover:bg-gray-200 transition duration-200">
                    ...
                    <div class="flex items-center">
                        <span class="text-xs lg:text-sm bg-gray-300 p-2 rounded-lg text-center">2
                            hours</span>
                    </div>
                </div>
            </div>
            ...
            <div class="flex">
                ...
                <div class="w-full flex justify-between p-4 bg-gray-100 hover:bg-gray-200 transition duration-200">
                    ...
                    <div class="flex items-center">
                        <span class="text-xs lg:text-sm bg-gray-300 p-2 rounded-lg text-center">3
                            days</span>
                    </div>
                </div>
            </div>
            ...
            <div class="flex">
                ...
                <div class="w-full flex justify-between p-4 bg-gray-100 hover:bg-gray-200 transition duration-200">
                    ...
                    <div class="flex items-center">
                        <span class="text-xs lg:text-sm bg-gray-300 p-2 rounded-lg text-center">5
                            days</span>
                    </div>
                </div>
            </div>
            ...
            <div class="flex">
                ...
                <div class="w-full flex justify-between p-4 bg-gray-100 hover:bg-gray-200 transition duration-200">
                    ...
                    <div class="flex items-center">
                        <span class="text-xs lg:text-sm bg-gray-300 p-2 rounded-lg text-center">6
                            days</span>
                    </div>
                </div>
            </div>
        ...
        <div class="w-full xl:w-1/3 bg-white rounded-lg shadow-xl px-4 overflow-y-hidden">
            ...
            <div class="relative h-full px-8 pt-2">
                ...
                <div class="flex items-center w-full my-6 -ml-1.5">
                    ...
                    <div class="w-11/12">
                        <p class="text-sm">
                            <a href="#" class="text-primary font-bold">Harold Hobbs</a> make payment for
                            order <a href="#" class="text-primary font-bold">#OR7546</a>.
                        </p>
                ...
                <div class="flex items-center w-full my-6 -ml-1.5">
                    ...
                    <div class="w-11/12">
                        <p class="text-sm">Invoice <a href="#" class="text-primary font-bold">#4563</a> was
                            created.</p>
                ...
                <div class="flex items-center w-full my-6 -ml-1.5">
                    ...
                    <div class="w-11/12">
                        <p class="text-sm"><a href="#" class="text-primary font-bold">Cecilia Hendric</a>
                            just confirmed email address.</p>
                ...
                <div class="flex items-center w-full my-6 -ml-1.5">
                    ...
                    <div class="w-11/12">
                        <p class="text-sm"><a href="#" class="text-primary font-bold">Jane Stillman</a>
                            canceled order <a href="#" class="text-primary font-bold">#OR7451</a>.</p>
                        <p class="text-xs text-gray-500">2 hours ago</p>
                    </div>
                </div>
                <!-- end::Timeline item -->
        ...
        <table class="w-full my-8 whitespace-nowrap">
            ...
            <tbody class="text-sm">
                <tr class="bg-gray-100 hover:bg-primary hover:bg-opacity-20 transition duration-200">
                    ...
                    <td class="py-3 pl-2">
                        <a href="#" class="bg-primary hover:bg-opacity-90 px-2 py-1 mr-2 text-gray-100 rounded-lg">View
                            Details</a>
                    </td>
                </tr>
